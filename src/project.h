...
struct Project {
    ...
    //
    // If |g_config->compilationDatabaseDirectory| is not empty, look for
    // .cquery or compile_commands.json in it, otherwise they are retrieved in
    // |root_directory|.
    //
    ...
    void Index(QueueManager* queue, WorkingFiles* working_files,
               LsRequestId id);
};
